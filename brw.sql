...
CREATE TABLE `personajes` (
  ...
  `salud` int(6) NOT NULL,
  `rareza` varchar(255) NOT NULL,
  `DañoBasico` varchar(255) NOT NULL,
  `Super` varchar(255) NOT NULL,
  `recarga` int(4) NOT NULL,
  `velocidad` int(4) NOT NULL,
  `Gadhet` varchar(255) NOT NULL,
...
-- Dump completed on 2022-12-13 16:57:51
